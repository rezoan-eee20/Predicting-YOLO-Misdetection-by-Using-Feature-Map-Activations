...
import tf_record_creation_util as tf_record_creation_util
...
flags.DEFINE_string(
    'output_dir', r'C:\Users\SIU856512759\Desktop\Dataset', '')

# flags.DEFINE_string('val_image_dir', '/media/bijay/Projects/Datasets/val2014',
#                     '')
# flags.DEFINE_string('val_annotations_file', '/media/bijay/Projects/Datasets/annotations/instances_val2014.json',
#                     '')

flags.DEFINE_string('val_image_dir', r'C:\Users\SIU856512759\Desktop\Dataset\Val\images',
                    '')
flags.DEFINE_string('val_annotations_file', r'C:\Users\SIU856512759\Desktop\Dataset\Val\annotations\instances_val2017.json',
                    '')

flags.DEFINE_bool('include_masks', False, 'Masks to include')
...
#def create_tf_record_for_specific_class(class_name):
...
def main(_):
    ...
    val_output_path = os.path.join(FLAGS.output_dir, 'person.tfrecord')
    filelistpath = r'C:\Users\SIU856512759\Desktop\YOLO_GM\tools\ValDataset_List.txt'
    create_tf_record(
